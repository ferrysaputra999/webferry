...
function travel_magazine_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info = '';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Documentation', 'travel-magazine' ) . ': </label><a href="' . esc_url( 'https://docs.rarathemes.com/docs/travel-magazine/' ) . '" target="_blank">' . __( 'Click here', 'travel-magazine' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'travel-magazine' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme=travel-magazine/' ) . '" target="_blank">' . __( 'Click here', 'travel-magazine' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme info', 'travel-magazine' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/wordpress-themes/travel-magazine/' ) . '" target="_blank">' . __( 'Click here', 'travel-magazine' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support Ticket', 'travel-magazine' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/support-ticket/' ) . '" target="_blank">' . __( 'Click here', 'travel-magazine' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'More WordPress Themes', 'travel-magazine' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/wordpress-themes/' ) . '" target="_blank">' . __( 'Click here', 'travel-magazine' ) . '</a></span><br />';
                                ...
                                <div class="post">
                                    <a href="<?php the_permalink(); ?>" class="post-thumbnail">
                                        ...
                                        if ( has_post_thumbnail() ) {
                                            the_post_thumbnail( 'travel-magazine-header-slider', array( 'itemprop' => 'image' ) ); 
                                        }else{
                                            numinous_get_fallback_svg( 'travel-magazine-header-slider' );
                                        } ?>
                                    </a>
    ...
    <a href="<?php the_permalink(); ?>" <?php if( $class ) echo 'class="post-thumbnail"'?>>
        <?php 
            if( has_post_thumbnail() ){
                ...
                numinous_get_fallback_svg( $img_size );
            } 
        ?>
    </a>
    <?php
    ...
    <div class="footer-b">
        <div class="container">
            <div class="site-info">
                ...
                <span class="by">
                <?php echo esc_html__( 'Travel Magazine | Developed By', 'travel-magazine' ); ?>
                <a href="<?php echo esc_url( 'https://rarathemes.com/' ); ?>" rel="nofollow" target="_blank"><?php echo esc_html__( 'Rara Theme', 'travel-magazine' ); ?></a>.
